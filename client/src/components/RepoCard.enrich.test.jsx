...
describe("RepoCard enrichment fields", () => {
  ...
  it("shows latest release tag", () => {
    renderCard({
      latest_release: { tag: "v2.0.0", published_at: "2024-01-01T00:00:00Z" },
    });
  ...
  it("shows last commit timeAgo", () => {
    renderCard({
      last_commit: { date: "2026-06-10T00:00:00Z", author: "Bob" },
    });
    ...
    renderCard(
      {
        open_prs: 5,
        ci_status: "SUCCESS",
        latest_release: { tag: "v1.0", published_at: "2024-01-01" },
      },

...
* [ ] Switching between board and list view takes multiple seconds. Add an indicator that something is happening and try to optimize the switch.
...
* [ ] make the day threshold configurable. The day threshold is the point where tomorrow becomes today. Currently we want this to be 4am. This should be configurable via an environment variable.
